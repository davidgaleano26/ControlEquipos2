...
namespace ControlEquipos2.Models
{
    ...
    public partial class solicitudes
    {
        ...
        public solicitudes()
        {
            this.solicitud_equipos = new HashSet<solicitud_equipos>();
        }
        ...
        public Nullable<decimal> id_persona_sol { get; set; }
        public Nullable<decimal> id_persona_ati { get; set; }
    
        public virtual personas personas { get; set; }
        public virtual personas personas1 { get; set; }
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<solicitud_equipos> solicitud_equipos { get; set; }
    }
}
